...
static void BOOM_increase(Tutorial1Sm* sm);

static void BOOM2_enter(Tutorial1Sm* sm);

static void BOOM2_exit(Tutorial1Sm* sm);

static void BOOM2_increase(Tutorial1Sm* sm);

static void BOOM3_enter(Tutorial1Sm* sm);

static void BOOM3_exit(Tutorial1Sm* sm);
...
static void BOOM_enter(Tutorial1Sm* sm)
{
    ...
    sm->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = BOOM_increase;
...
static void BOOM_increase(Tutorial1Sm* sm)
{
    ...
    // uml: INCREASE TransitionTo(BOOM2)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = Tutorial1Sm_StateId_BOOM2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for BOOM
}
...
{
    // setup trigger/event handlers
    sm->current_state_exit_handler = BOOM2_exit;
    sm->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = BOOM2_increase;
...
static void BOOM2_increase(Tutorial1Sm* sm)
{
    ...
    // uml: INCREASE TransitionTo(BOOM3)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = Tutorial1Sm_StateId_BOOM3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for BOOM2
}
...
{
    // setup trigger/event handlers
    sm->current_state_exit_handler = BOOM3_exit;
