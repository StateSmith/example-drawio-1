...
static void BOOM_increase(Tutorial1Sm* self);

static void BOOM2_enter(Tutorial1Sm* self);
static void BOOM2_exit(Tutorial1Sm* self);
static void BOOM2_increase(Tutorial1Sm* self);

static void BOOM3_enter(Tutorial1Sm* self);
static void BOOM3_exit(Tutorial1Sm* self);
...
const char* Tutorial1Sm_state_id_to_string(const enum Tutorial1Sm_StateId id)
{
    switch (id)
    {
        ...
        case Tutorial1Sm_StateId_BOOM2: return "BOOM2";
        case Tutorial1Sm_StateId_BOOM3: return "BOOM3";
...
static void BOOM_enter(Tutorial1Sm* self)
{
    ...
    self->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = BOOM_increase;
    
    // BOOM behavior
    // uml: enter / { light_boom1(); }
    {
        // Step 1: execute action `light_boom1();`
        light_boom1();
...
static void BOOM_increase(Tutorial1Sm* self)
{
    ...
    // BOOM behavior
    // uml: INCREASE TransitionTo(BOOM2)
    {
        ...
        // Step 3: Enter/move towards transition target `BOOM2`.
        BOOM2_enter(self);
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        self->state_id = Tutorial1Sm_StateId_BOOM2;
        // No ancestor handles event. Can skip nulling `self->ancestor_event_handler`.
        return;
    } // end of behavior for BOOM
}
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state BOOM2
////////////////////////////////////////////////////////////////////////////////

static void BOOM2_enter(Tutorial1Sm* self)
{
    // setup trigger/event handlers
    self->current_state_exit_handler = BOOM2_exit;
    self->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = BOOM2_increase;
    
    // BOOM2 behavior
    // uml: enter / { light_boom2(); }
    {
        // Step 1: execute action `light_boom2();`
        light_boom2();
    } // end of behavior for BOOM2
}
...
static void BOOM2_increase(Tutorial1Sm* self)
{
    ...
    // BOOM2 behavior
    // uml: INCREASE TransitionTo(BOOM3)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        BOOM2_exit(self);
        ...
        // Step 3: Enter/move towards transition target `BOOM3`.
        BOOM3_enter(self);
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        self->state_id = Tutorial1Sm_StateId_BOOM3;
        // No ancestor handles event. Can skip nulling `self->ancestor_event_handler`.
        return;
    } // end of behavior for BOOM2
}
...
////////////////////////////////////////////////////////////////////////////////
// event handlers for state BOOM3
////////////////////////////////////////////////////////////////////////////////

static void BOOM3_enter(Tutorial1Sm* self)
{
    // setup trigger/event handlers
    self->current_state_exit_handler = BOOM3_exit;
    
    // BOOM3 behavior
    // uml: enter / { boom3(); }
    {
        // Step 1: execute action `boom3();`
        light_boom3();
    } // end of behavior for BOOM3
}
...
static void ON3_enter(Tutorial1Sm* self)
{
    ...
    // uml: enter / { light_on3(); }
    {
        // Step 1: execute action `light_on3();`
        light_on3();
...
static void ON3_increase(Tutorial1Sm* self)
{
    ...
    // ON3 behavior
    // uml: INCREASE [count >= 3] TransitionTo(BOOM)
